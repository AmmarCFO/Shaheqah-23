      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <FadeInUp>
          <div className="text-center pt-8 pb-8 sm:pt-14 sm:pb-8">
            ...
            >
                <span className="text-[10px] font-bold tracking-[0.22em] uppercase text-purple-700 font-mono">Shaheqah 23 Project - Feasibility Dashboard</span>
            </motion.div>
            <h1 className="text-4xl sm:text-7xl font-black text-[#1D1D1F] tracking-tighter mb-4 leading-none select-none">
              Shaheqah 23<span className="text-[#8A6E99]">.</span>
            </h1>
            <p className="text-xs sm:text-xl text-gray-500 max-w-3xl mx-auto font-medium leading-relaxed tracking-tight px-4 mb-12">
                Riyadh Premium Property Analysis under <span className="text-[#8A6E99] font-bold">Hybrid Models</span>. 64 Unified Premium Units comprising 41 Short-Term Rental (STR) and 23 Long-Term Rental (LTR) layouts under 2BR configuration.
            </p>
          </div>
        </FadeInUp>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 sm:mb-12">
          <motion.div whileHover={{ y: -3 }} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm">
            ...
            <span className="text-2xl sm:text-4xl font-extrabold text-[#4A2C5A] tracking-tight">64 Units</span>
            <span className="text-xs text-gray-500 block mt-1">Blended 2 Bedroom Layouts</span>
          </motion.div>
          <motion.div whileHover={{ y: -3 }} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">STR Sub-Segment</span>
            <span className="text-2xl sm:text-4xl font-extrabold text-amber-600 tracking-tight">41 Units</span>
            <span className="text-xs text-gray-500 block mt-1">Short-Term Rental (STR)</span>
          </motion.div>
          <motion.div whileHover={{ y: -3 }} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block mb-1">LTR Sub-Segment</span>
            <span className="text-2xl sm:text-4xl font-extrabold text-blue-600 tracking-tight">23 Units</span>
            <span className="text-xs text-gray-500 block mt-1">Long-Term Rental (LTR)</span>
          </motion.div>
          <motion.div whileHover={{ y: -3 }} className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm">
        ...
        <div className="mb-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-6">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Select one of the 3 deployment models to simulate the 64-unit premium portfolio performance.</p>
            </div>
          </div>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-xs font-mono font-bold text-gray-400">23 Units</span>
                </div>
                <h4 className="font-bold text-gray-900 text-base mb-1">Long-Term Rental</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Stable 1-year residential leases, zero tenant turnover friction, and steady premium yields.</p>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between w-full">
                ...
                <span className="text-sm font-extrabold text-amber-600">SAR 2,080,212</span>
              </div>
            </button>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-xs font-mono font-bold text-gray-400">41 Units</span>
                </div>
                <h4 className="font-bold text-gray-900 text-base mb-1">STR Portfolio Segment</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Premium daily/monthly pricing capturing tourism surges, weekend bookings, and winter peaks.</p>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between w-full">
                <span className="text-[10px] text-gray-400 font-mono">BASE YR1 REVENUE</span>
                <span className="text-sm font-extrabold text-amber-500">SAR 10,172,100</span>
              </div>
            </button>
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-xs font-mono font-bold text-gray-400">64 Units (All)</span>
                </div>
                <h4 className="font-bold text-gray-900 text-base mb-1">Hybrid Portfolio Model</h4>
                <p className="text-xs text-gray-500 leading-relaxed">Optimal blend: 41 units running STR to maximize seasonal peaks, and 23 stable LTR units for solid baseline support.</p>
              </div>
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between w-full">
                <span className="text-[10px] text-gray-400 font-mono">BASE YR1 REVENUE</span>
                <span className="text-sm font-extrabold text-[#4A2C5A]">SAR 12,252,312</span>
              </div>
            </button>
          </div>
        </div>
                  ...
                  <div className="flex flex-col xl:flex-row items-center justify-between gap-4">
                       ...
                       <div className="flex items-center gap-3 text-left w-full xl:w-auto">
                           ...
                           <span className="text-xs sm:text-sm font-bold text-white font-mono">
                               {activeModel === 'ltr' 
                                 ? "Shaheqah 23 Executive LTR (23 Premium 2BR Units)" 
                                 : activeModel === 'str' 
                                   ? "Shaheqah 23 STR Segment (41 Premium 2BR Units)" 
                                   : "Shaheqah 23 Combined Portfolio (64 Premium 2BR Units)"}
                           </span>
                       </div>
